...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create roles (aligned to the normalized Spatie permissions tables)
        $allPermissions = [
            'manage-sites', 'view-sites', 'view-network-stats', 'manage-radius', 'reboot-router',
            'view-packages', 'manage-packages', 'view-invoices', 'manage-invoices', 'view-payments',
            'manage-payments', 'view-transactions', 'view-expenses', 'manage-expenses', 'view-reports',
            'view-customers', 'manage-customers', 'view-customer-details', 'send-message',
            'send-bulk-messages', 'download-customer-data', 'stk-push', 'change-expiry',
            'manage-subscriptions', 'change-packages', 'adjust-balances', 'flash-mac-binding',
            'delete-customers', 'create-customers', 'view-leads', 'manage-leads', 'view-tickets',
            'manage-tickets', 'view-dashboard', 'system-settings', 'view-templates', 'manage-templates',
        ];
        ...
        $this->call(VoucherWordsSeeder::class);

        $adminRole = Role::updateOrCreate(
            ['organization_id' => $organization->id, 'name' => 'Super Admin', 'guard_name' => 'sanctum']
        );
        $adminRole->syncPermissions($allPermissions);

        $managerRole = Role::updateOrCreate(
            ['organization_id' => $organization->id, 'name' => 'Manager', 'guard_name' => 'sanctum']
        );
        $managerRole->syncPermissions([
            'manage-sites', 'view-sites', 'view-network-stats', 'manage-radius',
            'view-packages', 'manage-packages', 'view-invoices', 'manage-invoices',
            'view-payments', 'manage-payments', 'view-transactions', 'view-customers',
            'manage-customers', 'view-customer-details', 'view-tickets', 'manage-tickets',
            'view-dashboard',
        ]);

        $staffRole = Role::updateOrCreate(
            ['organization_id' => $organization->id, 'name' => 'Staff', 'guard_name' => 'sanctum']
        );
        $staffRole->syncPermissions(['view-customers', 'view-customer-details', 'view-tickets', 'view-dashboard']);
