...
export const PPPoECustomersPage: React.FC = () => {
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
          <div className="relative w-full md:w-96">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-gray-200 dark:bg-slate-700 border border-gray-500 dark:border-transparent rounded-xl text-sm focus:border-none focus:ring-2 focus:ring-blue-500 transition-all text-gray-900 dark:text-white"
            />
          </div>
              ...
              {paginatedData.length > 0 ? paginatedData.map((customer, index) => {
                ...
                return (
                  <tr 
                    ...
                    className={`group hover:bg-gray-100 dark:hover:bg-slate-800/40 transition-all cursor-pointer ${index % 2 === 0 ? 'bg-gray-50 dark:bg-slate-800/20' : 'bg-white dark:bg-slate-900'}`}
                  >
